...
- add weekly limit display

### Changed

- **deps-ci**: bump actions/setup-node from 6 to 7 (#56)
- **deps**: update dependencies (#47)
- **deps**: update dependencies (#50)
- **deps-dev**: update dependencies (#51)
- **deps**: update dependencies (#52)
